...
namespace FinalAssessment.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        public CustomersController(ContextClass context)
        {
            _context = context;
        }
        ...
        // GET: api/Customers
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Customer>>> GetCutomers()
        {
            return await _context.Cutomers.ToListAsync();
        }
